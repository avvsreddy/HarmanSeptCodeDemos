...
namespace ProductsManagementApp.Migrations
{
    ...
    [Migration("20240926071927_ComplextTypeAddress")]
    partial class ComplextTypeAddress
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProductsManagementApp.Entities.Customer", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Address", "ProductsManagementApp.Entities.Customer.Address#Address", b1 =>
                        {
                            b1.IsRequired();
