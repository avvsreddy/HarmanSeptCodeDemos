...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductsManagementApp.Entities.Customer", b =>
                {
                    b.HasOne("ProductsManagementApp.Entities.Person", null)
                        .WithOne()
                        .HasForeignKey("ProductsManagementApp.Entities.Customer", "PersonID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ProductsManagementApp.Entities.Supplier", b =>
                {
                    b.HasOne("ProductsManagementApp.Entities.Person", null)
                        .WithOne()
                        .HasForeignKey("ProductsManagementApp.Entities.Supplier", "PersonID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
